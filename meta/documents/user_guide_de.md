...
In der folgenden Tabelle finden Sie Hinweise zu den einzelnen Formateinstellungen und empfohlenen Artikelfiltern für das Format **TracdelightCOM-Plugin**.
...
| Marke                  | **Pflichtfeld**<br/> Der Name des Herstellers des Artikels. Der **Externe Name** unter **Einstellungen » Artikel » Hersteller** wird bevorzugt, wenn vorhanden. |
...
| Lieferzeit             | Die Artikelverfügbarkeit unter **Einstellungen » Artikel » Artikelverfügbarkeit** oder die Übersetzung gemäß der Formateinstellung **Artikellverfügbarkeit**. |
